...
module Neurolibre
class ZenodoCreateBucketsResponder < Responder

  keyname :neurolibre_zenodo_create_buckets

  def define_listening
    required_params :external_call
    @event_action = "issue_comment.created"
    @event_regex = /\A@#{bot_name} zenodo create buckets\.?\s*$/i
  end
  ...
  def default_example_invocation
    "@#{bot_name} zenodo create buckets"
  end
end
end