...
module Neurolibre
class BuildExtendedPdfResponder < Responder

  keyname :neurolibre_draft_extended_pdf

  def define_listening
    required_params :external_call
    @event_action = "issue_comment.created"
    @event_regex = /\A@#{bot_name} build extended pdf\.?\s*$/i
  end
