...
module Neurolibre
class ZenodoUploadBookResponder < Responder

  keyname :neurolibre_zenodo_upload_book

  def define_listening
    required_params :external_call
    @event_action = "issue_comment.created"
    @event_regex = /\A@#{bot_name} zenodo upload book\.?\s*$/i
  end
