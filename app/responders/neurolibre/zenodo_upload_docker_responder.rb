...
module Neurolibre
class ZenodoUploadDockerResponder < Responder

  keyname :neurolibre_zenodo_upload_docker

  def define_listening
    required_params :external_call
    @event_action = "issue_comment.created"
    @event_regex = /\A@#{bot_name} zenodo upload docker\.?\s*$/i
  end
