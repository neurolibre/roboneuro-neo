...
module Neurolibre
class ZenodoUploadDataResponder < Responder

  keyname :neurolibre_zenodo_upload_data

  def define_listening
    required_params :external_call
    @event_action = "issue_comment.created"
    @event_regex = /\A@#{bot_name} zenodo upload data\.?\s*$/i
  end
